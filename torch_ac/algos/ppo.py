...
class PPOAlgo(BaseAlgo):
    ...
    def __init__(self, envs, acmodel, rew_gen_model, RND_model,  device=None, num_frames_per_proc=None, discount=0.99, lr=0.001, gae_lambda=0.95,
                 entropy_coef=0.01, value_loss_coef=0.5, max_grad_norm=0.5, recurrence=4,
                 adam_eps=1e-8, clip_eps=0.2, epochs=4, batch_size=256, preprocess_obss=None,
                 reshape_reward=None, agent_id = 0):
        num_frames_per_proc = num_frames_per_proc or 128

        super().__init__(envs, acmodel, rew_gen_model, RND_model, device, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
